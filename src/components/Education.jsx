...
const educationData = [
  {
    ...
    icon: (
      <svg className="w-10 h-10 text-blue-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        <path strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round" d="M12 3l9.5 5.5-9.5 5.5L2.5 8.5 12 3zm0 11v7m0 0H7m5 0h5" />
      </svg>
    ),
  },
  {
    ...
    icon: (
      <svg className="w-10 h-10 text-yellow-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        <rect x="4" y="4" width="16" height="16" rx="3" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round" />
        <path strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round" d="M8 12h8M12 8v8" />
      </svg>
    ),
  },
  {
...
const Education = () => {
  return (
    <section id="education" className="relative py-24 px-4 md:px-10 bg-gradient-to-br from-white via-gray-100 to-white text-black">
      <motion.div
        ...
        {educationData.map((edu, idx) => (
          ...
          >
            ...
            <div className="flex-1 text-center md:text-left">
              <h3 className="text-xl md:text-2xl font-bold text-black mb-1">{edu.degree}</h3>
              <p className="text-md text-gray-700 font-medium mb-1">{edu.institution}</p>
